...
function library:ConfigFix(cfg,location) 
	local copy = game:GetService("HttpService"):JSONDecode(readfile(location..cfg..".txt")) 
...
function library:New(name) 
	...
	Menu.Image = "http://www.roblox.com/asset/?id=7528570733" 
